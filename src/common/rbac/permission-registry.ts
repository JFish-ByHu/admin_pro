...
export const PERMISSION_DEFINITIONS: PermissionDefinition[] = [
  ...
  { code: USER_PERMISSION_CODES.DETAIL, name: '用户详情', type: 'api', sort: 2 },
  { code: USER_PERMISSION_CODES.CREATE, name: '创建用户', type: 'button', sort: 3 },
  { code: USER_PERMISSION_CODES.UPDATE, name: '更新用户', type: 'button', sort: 4 },
  { code: USER_PERMISSION_CODES.DELETE, name: '删除用户', type: 'button', sort: 5 },
  { code: MENU_PERMISSION_CODES.LIST, name: '菜单列表', type: 'api', sort: 6 },
  { code: MENU_PERMISSION_CODES.DETAIL, name: '菜单详情', type: 'api', sort: 7 },
  { code: MENU_PERMISSION_CODES.CREATE, name: '创建菜单', type: 'button', sort: 8 },
  { code: MENU_PERMISSION_CODES.UPDATE, name: '更新菜单', type: 'button', sort: 9 },
  { code: MENU_PERMISSION_CODES.DELETE, name: '删除菜单', type: 'button', sort: 10 },
  { code: MENU_PERMISSION_CODES.GRANT, name: '菜单授权', type: 'button', sort: 11 },
  { code: PERMISSION_PERMISSION_CODES.LIST, name: '权限列表', type: 'api', sort: 12 },
  { code: PERMISSION_PERMISSION_CODES.DETAIL, name: '权限详情', type: 'api', sort: 13 },
  {
  ...
  { code: ROLE_PERMISSION_CODES.DETAIL, name: '角色详情', type: 'api', sort: 19 },
  { code: ROLE_PERMISSION_CODES.CREATE, name: '创建角色', type: 'button', sort: 20 },
  { code: ROLE_PERMISSION_CODES.UPDATE, name: '更新角色', type: 'button', sort: 21 },
  { code: ROLE_PERMISSION_CODES.DELETE, name: '删除角色', type: 'button', sort: 22 }
]
